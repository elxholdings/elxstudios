...
import type { IntroAudioMixSetting } from './lib/intro-audio-config';
import WelcomePresentation from './welcome-presentation';

export default function LandingPage({ locale, forceIntro = false, introAudio }: { locale: string; forceIntro?: boolean; introAudio: IntroAudioMixSetting }) {
  return (
    <main className="no-scroll-experience relative h-svh overflow-hidden bg-[#061b1a] text-white">
      ...
      <WelcomePresentation locale={locale} forceIntro={forceIntro} audioMix={introAudio} />
